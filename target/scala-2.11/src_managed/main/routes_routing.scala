...
// @LINE:11
private[this] lazy val controllers_Application_TestStuff5_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("TestStuff"))))
private[this] lazy val controllers_Application_TestStuff5_invoker = createInvoker(
controllers.Application.TestStuff(fakeValue[String]),
HandlerDef(this.getClass.getClassLoader, "", "controllers.Application", "TestStuff", Seq(classOf[String]),"GET", """""", Routes.prefix + """TestStuff"""))
        

// @LINE:12
private[this] lazy val controllers_Application_Warenkorb6_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("Warenkorb"))))
private[this] lazy val controllers_Application_Warenkorb6_invoker = createInvoker(
...
// @LINE:13
private[this] lazy val controllers_Application_Kasse7_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("Kasse"))))
private[this] lazy val controllers_Application_Kasse7_invoker = createInvoker(
...
// @LINE:11
case controllers_Application_TestStuff5_route(params) => {
   call(params.fromQuery[String]("eingabe", None)) { (eingabe) =>
        controllers_Application_TestStuff5_invoker.call(controllers.Application.TestStuff(eingabe))
   }
}
        

// @LINE:12
case controllers_Application_Warenkorb6_route(params) => {
   call { 
        controllers_Application_Warenkorb6_invoker.call(controllers.Application.Warenkorb())
   }
}
        

// @LINE:13
case controllers_Application_Kasse7_route(params) => {
   call { 
        controllers_Application_Kasse7_invoker.call(controllers.Application.Kasse())
   }
}
